...
| <a name="input_sns_arn"></a> [sns\_arn](#input\_sns\_arn) | The arn for the SNS | `string` | `""` | no |
| <a name="input_sqs_arn"></a> [sqs\_arn](#input\_sqs\_arn) | The arn for the SNS | `string` | `""` | no |
