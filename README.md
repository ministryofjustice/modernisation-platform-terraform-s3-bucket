...
| <a name="input_use_private_acl"></a> [use\_private\_acl](#input\_use\_private\_acl) | Use canned 'private' ACL on the bucket instead of BucketOwnerEnforced ownership controls | `bool` | `true` | no |
