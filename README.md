...
| <a name="input_log_buckets"></a> [log\_buckets](#input\_log\_buckets) | Object for server access logging, containing bucket name and optional prefix | <pre>map(object({<br>    id   = string<br>    prefix = optional(string, null) # Allow optional prefix<br>  }))</pre> | `null` | no |
