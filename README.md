...
| <a name="input_enforce_kms_request_headers"></a> [enforce\_kms\_request\_headers](#input\_enforce\_kms\_request\_headers) | Whether to require SSE-KMS request headers in bucket policy. Disable for services relying on bucket default SSE-KMS encryption. | `bool` | `true` | no |
