...
| [aws_s3_bucket_notification.bucket_notification2](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_notification) | resource |
...
| <a name="input_event"></a> [event](#input\_event) | The event taking place | `string` | `""` | no |
...
| <a name="input_notification_enabled"></a> [notification\_enabled](#input\_notification\_enabled) | Activate notification bucket replication | `bool` | `false` | no |
...
| <a name="input_sns_arn"></a> [sns\_arn](#input\_sns\_arn) | The arn for the SNS | `string` | `"topic_arn"` | no |
